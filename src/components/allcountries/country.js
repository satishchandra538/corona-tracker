        ...
        <Fragment>
            {
                countries.map((country) => {
                    ...
                    return (
                        <div className="country col-md-4" key={country[0]}>
                            <div className="countryName">{country[0]}</div>
                            <img src={source} alt={`⛳`} />
                            <div className="infection">Total Cases <i class='fas fa-lungs-virus' style={{ 'color': 'white' }}></i>: {country[1][days].confirmed}</div>
